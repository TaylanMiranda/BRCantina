...
public class CadastroUsuarioJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Fone Principal");

        jLabel3.setText("E-Mail");

        jCheckBox1.setText("Permitir que essa pessoa acesse o programa");

        jPanel2.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jRadioButton1.setText("Administrador (acesso total ao programa)");

        jRadioButton2.setText("Atendente (permissões personalizadas)");
        ...
        jLabel6.setText("(Até 20 dígitos)");

        jLabel7.setText("Senha:");

        jLabel8.setText("Confirmar Senha:");

        jLabel9.setText("(Até 12 dígitos)");

        jCheckBox2.setText("Usuário Ativo");
